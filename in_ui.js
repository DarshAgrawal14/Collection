  ...
  return (
    <div className="app-container">
      <div className="max-w-container">
        ...
        <h1 className="app-title">🪙 Numismatic Collection Manager</h1>
        <p className="app-subtitle">Manage your currency and coin collection with ease</p>
        </div>
